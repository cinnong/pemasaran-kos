<nav class="bg-white border-gray-200 dark:bg-gray-900">
            ...
            <div class="flex">
                ...
                <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <a href="{{ route('beranda') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">KosPedia</span>
                    </a>

                    <!-- Form pencarian berdasarkan lokasi -->
                    <form action="{{ route('search') }}" method="GET" class="flex items-center">
                        <input type="text" name="location_query" placeholder="Cari berdasarkan lokasi..."
                            class="p-2 border rounded-l-lg">
                        <button type="submit" class="bg-blue-500 text-white p-2 rounded-r-lg">Cari</button>
                    </form>
    ...
    {{-- <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('input')" :active="request()->routeIs('input')">
                {{ __('input') }}
